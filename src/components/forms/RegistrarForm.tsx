...
const inputStyle = "w-full py-2 border-4 border-blue-400 text-gray-700 " +
    "rounded-lg hover:bg-blue-400 focus:outline-none " + 
    "focus:ring-2 focus:ring-blue-400"
const buttonStyle = "w-full py-2 bg-blue-400 text-white rounded-lg hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-400"

type registrarFormType = {
